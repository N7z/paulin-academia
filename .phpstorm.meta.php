...
'profile.edit','profile.update','profile.destroy','dashboard','sessions.create',
'sessions.store','exercises.index','exercises.create','exercises.store','workouts.index',
'workouts.create','workouts.store','workouts.show','workouts.exercises.create','workouts.exercises.store',
'workouts.exercises.destroy','register','login',
...
'_dashboard','auth.confirm-password','auth.forgot-password','auth.login','auth.register',
'auth.reset-password','auth.verify-email','components.application-logo','components.auth-session-status','components.bottom-nav',
'components.danger-button','components.dropdown','components.dropdown-link','components.flash-message','components.input-error',
'components.input-label','components.modal','components.nav-link','components.primary-button','components.responsive-nav-link',
'components.secondary-button','components.text-input','components.workout-tabs','dashboard','exercises.create',
'exercises.index','layouts.app','layouts.guest','layouts.main','layouts.navigation',
...
'workouts.create','workouts.exercises.create','workouts.index','workouts.sessions.create','workouts.show',
